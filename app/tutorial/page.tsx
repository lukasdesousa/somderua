...
const tutorialSteps = [
  {
    ...
    description:
      "Use o botão de download recebido por e-mail depois que o pagamento for aprovado.",
  },
  {
    title: "Baixe o arquivo",
    description:
      "Escolha uma pasta fácil de encontrar e aguarde o download terminar por completo.",
  },
  {
    title: "Extraia o conteúdo",
    description:
      "Use o 7-Zip para extrair as pastas antes de copiar as músicas.",
  },
  {
    title: "Transfira e aproveite",
    description:
      "Copie as pastas para o celular, computador ou pen drive e teste no seu aparelho.",
  },
];
...
const preparationTips = [
  {
    ...
    description:
      "Separe espaço para o arquivo baixado e para as pastas que serão extraídas.",
  },
  {
    title: "Internet estável",
    description:
      "Packs grandes podem levar algum tempo. Evite fechar o navegador durante o download.",
  },
  {
    title: "Pasta organizada",
    description:
      "Crie uma pasta chamada Som de Rua para localizar o conteúdo com facilidade depois.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Sim. Para transferir muitas músicas para um pen drive, o computador costuma deixar o processo mais simples.",
  },
  {
    question: "Por que o arquivo não abre logo após baixar?",
    answer:
      "O conteúdo está compactado. Aguarde o download terminar e use o 7-Zip para extrair o arquivo antes de abrir ou copiar as pastas de músicas.",
  },
  {
    question: "O que faço se o download parar?",
    answer:
      "Confira sua conexão e tente novamente pelo link recebido. Se o problema continuar, fale com o suporte.",
  },
];
...
export function generateMetadata(): Metadata {
  return buildMetadata({
    ...
    keywords: [
      "tutorial Som de Rua",
      "como baixar pack de músicas",
      "como passar músicas para pen drive",
    ],
  });
}
...
export default function TutorialPage() {
  ...
  return (
    <>
      ...
      <Breadcrumbs
        items={[{ name: "Início", href: "/" }, { name: "Tutorial" }]}
      />
      ...
      >
        ...
        <section className="mx-auto w-full max-w-6xl px-4 pb-10 pt-8 sm:px-6 md:pb-14 md:pt-12">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1
              id="tutorial-title"
              className="mt-5 font-nacelle text-4xl font-semibold text-white md:text-6xl"
            >
            ...
            <p className="mx-auto mt-5 max-w-3xl text-lg leading-relaxed text-slate-300 md:text-xl">
              Assista ao tutorial e veja como baixar, extrair e transferir seu
              Pack Som de Rua para o dispositivo que você usa.
            </p>
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-2 text-sm text-slate-300">
              ...
              <span className="rounded-lg border border-white/10 bg-white/5 px-3 py-2">
                Celular, computador e pen drive
              </span>
            </div>
          </div>
        ...
        <section
          ...
          aria-labelledby="tutorial-steps-title"
        >
          <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 md:py-20">
            <div className="max-w-2xl">
              ...
              <h2
                ...
                className="mt-3 font-nacelle text-3xl font-semibold text-white md:text-4xl"
              >
            ...
            <ol className="mt-8 grid gap-4 md:grid-cols-2">
              {tutorialSteps.map((step, index) => (
                <li
                  key={step.title}
                  className="group rounded-2xl border border-white/10 bg-slate-950/70 p-5 transition hover:border-emerald-400/30 hover:bg-slate-900/80"
                >
        ...
        <div className="mx-auto w-full max-w-6xl px-4 pt-14 sm:px-6 md:pt-20">
          <SevenZipExtractionGuide headingId="seven-zip-tutorial-title" />
        </div>

        <section
          className="mx-auto grid w-full max-w-6xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-[0.8fr_1.2fr] md:py-20"
        ...
        >
          <div>
            ...
            <p className="mt-4 leading-relaxed text-slate-400">
              Alguns cuidados simples evitam interrupções e ajudam você a
              encontrar o repertório depois da extração.
            </p>
          </div>
          ...
          <div className="grid gap-4">
            {preparationTips.map((tip) => (
              <article
                key={tip.title}
                className="rounded-2xl border border-indigo-400/15 bg-indigo-400/[0.06] p-5"
              >
                <h3 className="font-nacelle text-lg font-semibold text-indigo-100">
                  {tip.title}
                </h3>
                <p className="mt-2 leading-relaxed text-slate-400">
                  {tip.description}
        ...
        <section
          ...
          aria-labelledby="tutorial-faq-title"
        >
          <div className="rounded-3xl border border-white/10 bg-slate-950/70 p-6 sm:p-8 md:p-10">
            <div className="grid gap-10 md:grid-cols-[0.8fr_1.2fr]">
              <div>
                ...
                <h2
                  id="tutorial-faq-title"
                  className="mt-3 font-nacelle text-3xl font-semibold text-white"
                >
                  Dúvidas comuns
                </h2>
                <p className="mt-4 text-slate-400">
                  Se ainda precisar, nossa área de suporte está logo abaixo.
                </p>
              </div>
              <div className="grid gap-4">
                {faqs.map((faq) => (
            ...
            <div className="mt-10 flex flex-col items-center justify-between gap-5 rounded-2xl border border-emerald-400/20 bg-emerald-400/[0.07] p-5 text-center sm:flex-row sm:text-left">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-400">
                  Fale com o suporte e conte em qual etapa encontrou
                  dificuldade.
                </p>
              </div>
              <Link
                href="/suporte"
                className="btn shrink-0 bg-linear-to-t from-emerald-500 to-lime-400 font-bold text-slate-950 hover:from-emerald-400 hover:to-lime-300"
              >
                Falar com o suporte
              </Link>
            </div>
