        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            <p className="text-lg text-indigo-200/65">
              Aqui, prezamos a sua experiência ao máximo. Queremos te mostrar os nossos pontos positivos:
            </p>
          </div>
          {/* Items */}
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            ...
            <article>
              ...
              <p className="text-indigo-200/65">
                Na compra de nosso pack de músicas, ganhe 50% de desconto para garantir o próximo pack quando lançarmos.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                Após o pagamento, nada de ficar esperando. Nosso sistema redireciona você automaticamente para o download.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                As músicas em nosso pack são embutidas com qualidade superior, para a melhor experiência possível.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                Algum erro ocorreu durante ou após a compra? Devolvemos 100% do seu dinheiro em minutos.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                Garantimos que não há nenhuma faixa músical repetida em nosso pack.
              </p>
            </article>
          </div>
        </div>
